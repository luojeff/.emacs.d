...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces 
   ...
   ;; mode-line
   `(mode-line ((,class (:foreground nil :background ,active-frame-border :box ,active-frame-border)))) ;; ACTIVE FRAME BORDER
   `(mode-line-inactive ((,class (:foreground ,fg1 :background ,inactive-frame-border :box ,inactive-frame-border)))) ;; IN-ACTIVE FRAME BORDER
   ;; mu4e
